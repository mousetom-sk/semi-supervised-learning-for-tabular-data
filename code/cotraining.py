...
from common.classification import CoTrainingClassifier, make_pipeline
...
static_params = {
    ...
    "base_estimator2": RandomForestClassifier(
...
est = GridSearch(CoTrainingClassifier, static_params, distributions)
